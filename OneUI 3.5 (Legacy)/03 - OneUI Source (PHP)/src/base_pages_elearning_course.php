...
<div class="bg-white">
    <section class="content content-mini content-mini-full content-boxed overflow-hidden">
        <ol class="breadcrumb">
            <li><a class="text-primary-dark" href="base_pages_elearning_courses.php">Courses</a></li>
            <li><a href="base_pages_elearning_course.php">Learn HTML5</a></li>
        </ol>
    </section>
</div>
<!-- END Navigation -->
                    ...
                    <table class="table table-borderless table-vcenter">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="base_pages_elearning_lesson.php">1.1 HTML5 Intro (free preview)</a>
                                </td>
                                <td class="text-right">
