                    ...
                    <div class="block">
                        ...
                        <div class="block-content tab-content mheight-200">
                            <div class="tab-pane active" id="travel-flights">
                                <form class="form-horizontal" action="base_pages_travel_home.php" method="post" onsubmit="return false;">
    ...
    <section class="content content-full content-boxed">
        ...
        <div class="row push-50">
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo29.jpg');" href="base_pages_travel_package.php">
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo30.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo31.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo32.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo33.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo34.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo35.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo21.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed bg-image" style="background-image: url('assets/img/photos/photo36.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
                        <span class="text-white-op"><i class="fa fa-star"></i></span>
...
<div class="bg-gray-light border-t border-b">
    <section class="content content-full content-boxed">
        ...
        <div class="push-20-t push-20 text-center">
            ...
            <a class="btn btn-rounded btn-noborder btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated bounceIn" href="base_pages_contact.php">
                <i class="fa fa-envelope-o push-5-r"></i> Get in touch
            </a>
        </div>
        <!-- END Section Content -->
    </section>
