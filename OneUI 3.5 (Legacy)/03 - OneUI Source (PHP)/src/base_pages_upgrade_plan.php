...
<div class="bg-primary-dark">
    <section class="content content-full content-boxed">
        ...
        <div class="push-100-t push-50 text-center">
            ...
            <h2 class="h5 text-white-op visibility-hidden" data-toggle="appear" data-class="animated fadeInDown">Step up your game with a better plan.</h2>
        </div>
        <!-- END Section Content -->
    </section>
</div>
            ...
            <div class="col-sm-6 col-lg-3 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeInUp">
                ...
                <a class="block block-bordered block-link-hover3 text-center" href="javascript:void(0)">
                    <div class="block-header">
                        <h3 class="block-title text-primary">Developer</h3>
                    </div>
                    <div class="block-content block-content-full bg-gray-lighter">
                        <div class="h1 font-w700 text-primary push-10">$9</div>
                    ...
                    <div class="block-content block-content-mini block-content-full bg-gray-lighter">
                        <span class="btn btn-primary">
                            <i class="fa fa-check push-5-r"></i>Current Plan
                        </span>
                    </div>
                </a>
                <!-- END Developer Plan -->
                ...
                <a class="block block-bordered block-link-hover3 text-center" href="javascript:void(0)">
                    ...
                    <div class="block-content block-content-mini block-content-full bg-gray-lighter">
                        <span class="btn btn-default">
                            <i class="fa fa-arrow-up push-5-r"></i>Upgrade
                        </span>
                    </div>
                </a>
                <!-- END Startup Plan -->
...
<div class="bg-gray-lighter">
    <section class="content content-full content-boxed">
        ...
        <div class="push-20-t push-20 text-center">
            ...
            <a class="btn btn-rounded btn-noborder btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated bounceIn" href="base_pages_upgrade_plan.php">Upgrade Today</a>
        </div>
        <!-- END Section Content -->
    </section>
</div>
...
<!-- Mini Stats -->
<div class="bg-image" style="background-image: url('<?php echo $one->assets_folder; ?>/img/photos/photo16@2x.jpg');">
