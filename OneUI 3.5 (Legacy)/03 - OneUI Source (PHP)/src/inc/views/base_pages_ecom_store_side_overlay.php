<?php
/**
 * base_pages_ecom_store_side_overlay.php
 *
 * Author: pixelcave
 *
 * The side overlay of e-Commerce Store pages (Backend)
 *
 */
?>
<!-- Side Overlay-->
                        ...
                        <table class="table table-borderless table-vcenter">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="h5" href="base_pages_ecom_store_product.php">Iconic</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="h5" href="base_pages_ecom_store_product.php">Mailday</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="h5" href="base_pages_ecom_store_product.php">Office Suite</a>
                                ...
                                <tr>
                                    <td class="text-right" colspan="4">
                                        <a class="btn btn-sm btn-warning" href="base_pages_ecom_store_checkout.php">
                                            <i class="fa fa-refresh push-5-r"></i> Reset
                                        </a>
                                        <a class="btn btn-sm btn-success" href="base_pages_ecom_store_checkout.php">
