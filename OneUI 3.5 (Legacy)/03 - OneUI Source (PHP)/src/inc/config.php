...
$one                               = new Template('OneUI', '3.5', 'assets'); // Name, version and assets folder's name
...
$one->main_nav                     = array(
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Dashboard v2</span>',
        'icon'  => 'si si-rocket',
        'url'   => 'base_pages_dashboard_v2.php'
    ),
    array(
        'name'  => '<span class="sidebar-mini-hide">Dashboard v3</span>',
        'icon'  => 'si si-cup',
        'url'   => 'base_pages_dashboard_v3.php'
    ),
    array(
    ...
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Image Cropper',
                'url'   => 'base_comp_image_cropper.php'
            ),
            array(
                'name'  => 'Charts (Various)',
    ...
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Team',
                'url'   => 'base_pages_team.php'
            ),
            array(
                'name'  => 'About',
                'url'   => 'base_pages_about.php'
            ),
            array(
                'name'  => 'Upgrade Plan',
                'url'   => 'base_pages_upgrade_plan.php'
            ),
            array(
                'name'  => 'Contact',
                'url'   => 'base_pages_contact.php'
            ),
            array(
                'name'  => 'Support',
                'url'   => 'base_pages_support.php'
            ),
            array(
                'name'  => 'Coming Soon',
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Page Packs</span>',
        'icon'  => 'si si-layers',
        'sub'   => array(
            array(
                'name'  => 'Crypto',
                ...
                'sub'    => array(
                    array(
                        'name'  => 'Dashboard',
                        'url'   => 'base_pages_crypto_dashboard.php'
                    ),
                    array(
                        'name'  => 'Buy/Sell',
                        'url'   => 'base_pages_crypto_buy_sell.php'
                    ),
                    array(
                        'name'  => 'Wallets',
                        'url'   => 'base_pages_crypto_wallets.php'
                    ),
                    array(
                        'name'  => 'Settings',
                        'url'   => 'base_pages_crypto_settings.php'
                    )
                )
            ),
            array(
            ...
            array(
                ...
                'sub'    => array(
                    array(
                        'name'  => 'Home',
                        'url'   => 'base_pages_ecom_store_home.php'
                    ),
                    array(
                        'name'  => 'Search Results',
                        'url'   => 'base_pages_ecom_store_search.php'
                    ),
                    array(
                        'name'  => 'Products List',
                        'url'   => 'base_pages_ecom_store_products.php'
                    ),
                    array(
                        'name'  => 'Product Page',
                        'url'   => 'base_pages_ecom_store_product.php'
                    ),
                    array(
                        'name'  => 'Checkout',
                        'url'   => 'base_pages_ecom_store_checkout.php'
                    )
                )
            ),
            array(
            ...
            array(
                ...
                'sub'    => array(
                    array(
                        'name'  => 'Dashboard',
                        'url'   => 'base_pages_projects_dashboard.php'
                    ),
                    array(
                        'name'  => 'Project',
                        'url'   => 'base_pages_projects_view.php'
                    ),
                    array(
                        'name'  => 'Create',
                        'url'   => 'base_pages_projects_create.php'
                    ),
                    array(
                        'name'  => 'Edit',
                        'url'   => 'base_pages_projects_edit.php'
                    )
                )
            ),
            array(
                ...
                'sub'    => array(
                    array(
                        'name'  => 'Classic',
                        'url'   => 'base_pages_blog_classic.php'
                    ),
                    array(
                        'name'  => 'List',
                        'url'   => 'base_pages_blog_list.php'
                    ),
                    array(
                        'name'  => 'Grid',
                        'url'   => 'base_pages_blog_grid.php'
                    ),
                    array(
                        'name'  => 'Story',
                        'url'   => 'base_pages_blog_story.php'
                    ),
                    array(
                        'name'  => 'Story Cover',
                        'url'   => 'base_pages_blog_story_cover.php'
                    )
                )
            ),
            array(
                ...
                'sub'    => array(
                    array(
                        'name'  => 'Courses',
                        'url'   => 'base_pages_elearning_courses.php'
                    ),
                    array(
                        'name'  => 'Course',
                        'url'   => 'base_pages_elearning_course.php'
                    ),
                    array(
                        'name'  => 'Lesson',
                        'url'   => 'base_pages_elearning_lesson.php'
                    )
                )
            ),
            array(
                ...
                'sub'    => array(
                    array(
                        'name'  => 'Agency',
                        'url'   => 'base_pages_travel_agency.php'
                    ),
                    array(
                        'name'  => 'Package',
                        'url'   => 'base_pages_travel_package.php'
                    ),
                    array(
                        'name'  => 'Guide',
                        'url'   => 'base_pages_travel_guide.php'
                    )
                )
            )
        )
