                ...
                <section class="content content-full content-boxed">
                    ...
                    <div class="push-150-t push-100 text-center">
                        ...
                        <div class="push-50-t push-20 text-center">
                            <a class="btn btn-noborder btn-lg btn-success push-10-r push-5 visibility-hidden" data-toggle="appear" data-class="animated fadeInLeft" href="https://1.envato.market/xWy">
        ...
        <div class="bg-gray-lighter">
            <section class="content content-boxed">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a class="block block-link-hover2 ribbon ribbon-bookmark ribbon-success" href="base_pages_crypto_dashboard.php">
                            <div class="ribbon-box font-w600">New!</div>
                            <img class="img-responsive" src="assets/img/various/promo_preview_backend_crypto.jpg" alt="">
                            <div class="block-content">
                                <div class="h4 push-5">Crypto Dashboard</div>
                                <p class="text-muted">Exchange Pages</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4">
            ...
            <div class="bg-primary-dark-op">
                <section class="content content-full content-boxed overflow-hidden">
                    ...
                    <div class="h5 text-center visibility-hidden" data-toggle="appear" data-class="animated fadeInUp">
                        <span class="text-gray">Would you like to read more reviews and testimonials? You can find them over at <a class="text-primary-light" href="https://1.envato.market/xWy">OneUI page on Themeforest</a>.</span>
                    </div>
                    <!-- END Section Content -->
                </section>
            </div>
        ...
        <div class="bg-white">
            <section class="content content-full content-boxed">
                ...
                <div class="push-20-t push-20 text-center">
                    <h2 class="push-50-t push-10 text-black visibility-hidden" data-toggle="appear" data-class="animated fadeInDown">Crafted with <i class="fa fa-heart text-city"></i> by <a href="https://1.envato.market/ydb">pixelcave</a></h2>
                    ...
                    <a class="btn btn-noborder push-50 btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated fadeInUp" href="https://1.envato.market/xWy">
                        <i class="fa fa-shopping-cart push-10-r"></i>Purchase
                    </a>
                </div>
                <!-- END Section Content -->
