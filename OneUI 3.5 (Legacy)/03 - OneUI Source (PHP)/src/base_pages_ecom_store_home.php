...
<section class="content content-boxed">
    ...
    <div class="row">
            ...
            <div class="block">
                <div class="img-container">
                    ...
                    <div class="img-options">
                        <div class="img-options-content">
                            <div class="push-20">
                                <a class="btn btn-sm btn-default" href="base_pages_ecom_store_product.php">View</a>
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Iconic</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Mailday</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Office Suite</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Steam Games</a>
                    </div>
        ...
        <div class="col-xs-12 text-right push">
            <a class="font-w600 link-effect" href="base_pages_ecom_store_products.php">View More New Arrivals <i class="fa fa-angle-right"></i></a>
        </div>
    </div>
    <!-- END New Arrivals -->
    ...
    <div class="row">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Video UI Kit</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Super Badges Pack</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">RPG Game Pack</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Antivir</a>
                    </div>
        ...
        <div class="col-xs-12 text-right push">
            <a class="font-w600 link-effect" href="base_pages_ecom_store_products.php">View More Best Sellers <i class="fa fa-angle-right"></i></a>
        </div>
    </div>
    <!-- END Best Sellers -->
    ...
    <div class="row">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">MapNow</a>
                    </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        <div class="h4 font-w600 text-success pull-right push-10-l">$44</div>
                        <a class="h4" href="base_pages_ecom_store_product.php">Calendious</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">Todo App</a>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    <div class="push-10">
                        ...
                        <a class="h4" href="base_pages_ecom_store_product.php">e-Music</a>
                    </div>
        ...
        <div class="col-xs-12 text-right push">
            <a class="font-w600 link-effect" href="base_pages_ecom_store_products.php">View More Best Rated <i class="fa fa-angle-right"></i></a>
        </div>
    </div>
    <!-- END Best Rated -->
</section>
...
<div class="bg-gray-light border-t border-b">
    <section class="content content-full content-boxed">
        ...
        <div class="push-20-t push-20 text-center">
            ...
            <a class="btn btn-rounded btn-noborder btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated bounceIn" href="base_pages_ecom_store_products.php">Explore Store <i class="fa fa-arrow-right"></i></a>
        </div>
        <!-- END Section Content -->
    </section>
</div>
