    ...
    <section class="content content-boxed">
        ...
        <div class="row items-push push-20-t nice-copy">
            <div class="col-md-6">
                ...
                <h3 class="h5 font-w600 text-uppercase push-10">How did you build this app?</h3>
...
<div class="bg-gray-lighter">
    <section class="content content-full content-boxed">
        ...
        <div class="push-20-t push-20 text-center">
            <h3 class="h4 push-20 visibility-hidden" data-toggle="appear">Do you like our product? Let us know what you think!</h3>
