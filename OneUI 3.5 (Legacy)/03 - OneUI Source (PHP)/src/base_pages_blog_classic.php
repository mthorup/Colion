                ...
                <div class="block">
                    <div class="block-content">
                        <div class="row items-push">
                            <div class="col-md-4">
                                <a href="base_pages_blog_story.php">
                            ...
                            <div class="col-md-8">
                                ...
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="base_pages_blog_story.php">Top 10 Destinations</a></h4>
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a class="btn btn-default" href="base_pages_blog_story.php">Continue Reading..</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="block-content">
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                ...
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="base_pages_blog_story.php">Follow Your Dreams</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="base_pages_blog_story.php">Continue Reading..</a>
                    ...
                    <div class="block-content">
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                ...
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="base_pages_blog_story.php">Travel &amp; Work</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="base_pages_blog_story.php">Continue Reading..</a>
                    ...
                    <div class="block-content">
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                ...
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="base_pages_blog_story.php">Sleep Better</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="base_pages_blog_story.php">Continue Reading..</a>
                    ...
                    <div class="block-content">
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                ...
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="base_pages_blog_story.php">Black &amp; White</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="base_pages_blog_story.php">Continue Reading..</a>
                    ...
                    <div class="block-content">
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                ...
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="base_pages_blog_story.php">Exploring the Alps</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="base_pages_blog_story.php">Continue Reading..</a>
            ...
            <div class="col-lg-4">
                ...
                <div class="block">
                    ...
                    <div class="block-content block-content-full">
                        <form action="base_pages_blog_classic.php" method="post">
                        ...
                        <ul class="list list-simple">
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="base_pages_blog_story.php">Exploring the Alps</a>
                                </div>
                            ...
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="base_pages_blog_story.php">Travel &amp; Work</a>
                                </div>
                            ...
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="base_pages_blog_story.php">Black &amp; White</a>
                                </div>
                            ...
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="base_pages_blog_story.php">Sleep Better</a>
                                </div>
...
<div class="bg-gray-light border-t border-b">
    <section class="content content-full content-boxed">
        ...
        <div class="push-20-t push-20 text-center">
            ...
            <a class="btn btn-rounded btn-noborder btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated bounceIn" href="javascript:void(0)">Get Started Today</a>
        </div>
        <!-- END Section Content -->
    </section>
</div>
