...
<div class="content content-narrow">
    ...
    <!-- For more info and examples you can check out https://github.com/uxsolutions/bootstrap-datepicker -->
    ...
    <!-- AutoNumeric -->
    <!-- AutoNumeric (.js-autonumeric-* classes are initialized in App() -> uiHelperAutoNumeric()) -->
    <!-- For more info and examples you can check out https://github.com/autoNumeric/autoNumeric -->
    <h2 class="content-heading">AutoNumeric</h2>
    <div class="row">
        <div class="col-lg-6">
            <!-- AutoNumeric (Bootstrap forms) -->
            <div class="block">
                <div class="block-header">
                    <ul class="block-options">
                        <li>
                ...
                <div class="block-content block-content-full">
                    <form class="form-horizontal" action="base_forms_pickers_more.php" method="post" onsubmit="return false;">
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-dollar">US Dollar</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-dollar form-control" type="text" id="example-autonumeric-dollar" name="example-autonumeric-dollar">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-euro">Euro</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-euro form-control" type="text" id="example-autonumeric-euro" name="example-autonumeric-euro">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-pound">British Pound</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-pound form-control" type="text" id="example-autonumeric-pound" name="example-autonumeric-pound">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-franc">Swiss Franc</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-franc form-control" type="text" id="example-autonumeric-franc" name="example-autonumeric-franc">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-yen">Japanese Yen</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-yen form-control" type="text" id="example-autonumeric-yen" name="example-autonumeric-yen">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-yuan">Chinese Yuan</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-yuan form-control" type="text" id="example-autonumeric-yuan" name="example-autonumeric-yuan">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="example-autonumeric-brl">Brazilian Real</label>
                            <div class="col-md-6">
                                <input class="js-autonumeric-brl form-control" type="text" id="example-autonumeric-brl" name="example-autonumeric-brl">
                            </div>
                        </div>
                    </form>
                </div>
            </div>
            <!-- END AutoNumeric (Bootstrap forms) -->
        </div>
        <div class="col-lg-6">
            <!-- AutoNumeric (Material forms) -->
            <div class="block">
                <div class="block-header">
                    <ul class="block-options">
                        <li>
                ...
                <div class="block-content">
                    <form class="form-horizontal push-10-t" action="base_forms_pickers_more.php" method="post" onsubmit="return false;">
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-dollar form-control" type="text" id="example-autonumeric-dollar2" name="example-autonumeric-dollar2">
                                    <label for="example-autonumeric-dollar2">US Dollar</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-euro form-control" type="text" id="example-autonumeric-euro2" name="example-autonumeric-euro2">
                                    <label for="example-autonumeric-euro2">Euro</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-pound form-control" type="text" id="example-autonumeric-pound2" name="example-autonumeric-pound2">
                                    <label for="example-autonumeric-pound2">British Pound</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-franc form-control" type="text" id="example-autonumeric-franc2" name="example-autonumeric-franc2">
                                    <label for="example-autonumeric-franc2">Swiss Franc</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-yen form-control" type="text" id="example-autonumeric-yen2" name="example-autonumeric-yen2">
                                    <label for="example-autonumeric-yen2">Japanese Yen</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-yuan form-control" type="text" id="example-autonumeric-yuan2" name="example-autonumeric-yuan2">
                                    <label for="example-autonumeric-yuan2">Chinese Yuan</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-8">
                                <div class="form-material">
                                    <input class="js-autonumeric-brl form-control" type="text" id="example-autonumeric-brl2" name="example-autonumeric-brl2">
                                    <label for="example-autonumeric-brl2">Brazilian Real</label>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <!-- END AutoNumeric (Material forms) -->
        </div>
    </div>
    <!-- END AutoNumeric -->
...
<script src="<?php echo $one->assets_folder; ?>/js/plugins/autonumeric/autoNumeric.min.js"></script>
