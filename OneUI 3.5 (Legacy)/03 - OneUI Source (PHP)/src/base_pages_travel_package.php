...
<div class="bg-white">
    <section class="content content-full content-boxed">
        ...
        <div class="push-50-t push-50 text-center">
            ...
            <a class="btn btn-rounded btn-noborder btn-lg btn-success visibility-hidden" data-toggle="appear" data-class="animated bounceIn" href="base_pages_contact.php">Get in touch today</a>
        </div>
        <!-- END Section Content -->
    </section>
</div>
    ...
    <section class="content content-full content-boxed">
        ...
        <div class="row push-50">
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed block-link-hover2 bg-image" style="background-image: url('assets/img/photos/photo35.jpg');" href="base_pages_travel_package.php">
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed block-link-hover2 bg-image" style="background-image: url('assets/img/photos/photo29.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
                        <span class="text-white"><i class="fa fa-heart"></i></span>
                    </div>
            ...
            <div class="col-sm-6 col-md-4">
                <a class="block block-themed block-link-hover2 bg-image" style="background-image: url('assets/img/photos/photo33.jpg');" href="base_pages_travel_package.php">
                    <div class="block-header text-right push-150">
...
<!-- Page JS Code -->
<script src="<?php echo $one->assets_folder; ?>/js/pages/base_pages_travel_package.js"></script>
<script>
    jQuery(function(){
