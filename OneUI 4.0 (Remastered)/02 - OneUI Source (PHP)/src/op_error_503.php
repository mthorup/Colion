...
<div class="hero">
    <div class="hero-inner text-center">
        <div class="content content-full bg-white overflow-hidden">
            <div class="py-4">
                <!-- Error Header -->
                <h1 class="display-1 text-smooth invisible" data-toggle="appear" data-class="animated rollIn">503</h1>
                <h2 class="h3 font-w300 text-muted invisible mb-5" data-toggle="appear" data-class="animated fadeInUp">We are sorry but our service is currently not available..</h2>
                <!-- END Error Header -->
