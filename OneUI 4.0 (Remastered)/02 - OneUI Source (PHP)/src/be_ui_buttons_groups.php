    ...
    <div class="block">
        ...
        <div class="block-content">
            ...
            <div class="btn-toolbar mb-2" role="toolbar" aria-label="Icons Toolbar with button groups">
                ...
                <div class="btn-group mr-2 mb-2" data-toggle="buttons" role="group" aria-label="Icons Text group">
                    <button type="button" class="btn btn-primary">
                ...
                <div class="btn-group mr-2 mb-2" data-toggle="buttons" role="group" aria-label="Icons Align group">
                    <button type="button" class="btn btn-primary">
                ...
                <div class="btn-group mr-2 mb-2" data-toggle="buttons" role="group" aria-label="Icons List group">
                    <button type="button" class="btn btn-primary">
            ...
            <div class="btn-toolbar mb-2" role="toolbar" aria-label="Icons Outline Toolbar with button groups">
                ...
                <div class="btn-group mr-2 mb-2" data-toggle="buttons" role="group" aria-label="Icons Outline Text group">
                    <button type="button" class="btn btn-outline-secondary">
                        <i class="fa fa-fw fa-bold"></i>
                    </button>
                    <button type="button" class="btn btn-outline-secondary">
                ...
                <div class="btn-group mr-2 mb-2" data-toggle="buttons" role="group" aria-label="Icons Outline Align group">
                    <button type="button" class="btn btn-outline-secondary">
                        <i class="fa fa-fw fa-align-left"></i>
                    </button>
                    <button type="button" class="btn btn-outline-secondary">
                ...
                <div class="btn-group mr-2 mb-2" data-toggle="buttons" role="group" aria-label="Icons Outline List group">
                    <button type="button" class="btn btn-outline-secondary">
                        <i class="fa fa-fw fa-list-ul"></i>
                    </button>
                    <button type="button" class="btn btn-outline-secondary">
