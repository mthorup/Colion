        ...
        <div class="hero-inner">
            <div class="content content-full text-center">
                ...
                <h1 class="display-4 font-w600 mb-3 text-white invisible" data-toggle="appear" data-class="animated fadeInDown">
                    OneUI <span class="font-w300">4.0 Remastered</span>
                </h1>
                <h2 class="h3 font-w400 text-white-50 mb-5 invisible" data-toggle="appear" data-class="animated fadeInDown" data-timeout="300">
                    Build your next idea with one super flexible UI framework. Reimagined and rebuilt for 2019 projects.
                </h2>
...
<div id="one-remastered" class="bg-white">
    <div class="content content-full">
        <div class="py-5 text-center">
            ...
            <h3 class="font-w400 text-muted mb-5">
                OneUI 4.0 was carefully crafted for your new projects using the latest tech.
            </h3>
            <div class="row">
                <div class="col-sm-6 col-md-4 col-xl-3 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        <div class="block-content block-content-full">
                            ...
                            <p class="font-size-sm text-muted text-left">
                                The latest Bootstrap version now powers OneUI 4.0 framework. Flexbox support and tons of new features are ready for you to use.
                            </p>
                        </div>
                    </div>
                    <!-- END Bootstrap 4 -->
                ...
                <div class="col-sm-6 col-md-4 col-xl-3 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        <div class="block-content block-content-full">
                            ...
                            <p class="font-size-sm text-muted text-left">
                                OneUI 4.0 was built with Sass, overriding and extending Bootstrap in an intelligent way to ensure a perfect and modular workflow.
                            </p>
                        </div>
                    </div>
                    <!-- END Sass -->
                ...
                <div class="col-sm-6 col-md-4 col-xl-3 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        <div class="block-content block-content-full">
                            ...
                            <p class="font-size-sm text-muted text-left">
                                OneUI 4.0 was built with ES6, the new major JavaScript release which enables us writing cleaner and better code.
                            </p>
                        </div>
                    </div>
                    <!-- END ES6 -->
                ...
                <div class="col-sm-6 col-md-4 col-xl-3 invisible" data-toggle="appear">
                    ...
                    <div class="block block-rounded block-fx-pop">
                        <div class="block-content block-content-full">
                            ...
                            <p class="font-size-sm text-muted text-left">
                                OneUI 4.0 comes packed with the latest Font Awesome version, bringing you over 1300 freshly made icons for your projects.
                            </p>
                        </div>
                    </div>
                    <!-- END ES6 -->
    ...
    <div class="content content-full">
        <div class="py-5 py-md-8 text-center">
            ...
            <h3 class="font-w400 text-muted mb-4 invisible" data-toggle="appear" data-class="animated fadeInDown" data-timeout="300">
                Passionate web design and development with over 11.000 customers worldwide.
            </h3>
            <span class="m-2 d-inline-block invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="600">
                <a class="btn btn-success px-4 py-2" data-toggle="click-ripple" href="https://1.envato.market/xWy">
                    <i class="fa fa-fw fa-shopping-cart mr-1"></i> Purchase
    ...
    <div class="content py-5">
        <div class="row font-size-sm">
            ...
            <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                <a class="font-w600" href="https://1.envato.market/xWy" target="_blank"><?php echo $one->name . ' ' . $one->version; ?></a> &copy; <span data-toggle="year-copy">2018</span>
            </div>
        </div>
    </div>
</footer>
